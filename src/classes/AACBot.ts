...
// import SocketEvent from '../interfaces/SocketEvent.interface';
...
//     this.emitter.on('socketIncomingEvent', async (event: SocketEvent) => {
//       if (event.name === 'updateChatLines' && event.data.chatLine === 'ping') {
//         this.sendMessage('pong');
//       }
//     });
//     this.emitter.on('socketOutgoingEvent', async (event: SocketEvent) => {
//       //console.log(event);
//     });
//   }
// }
